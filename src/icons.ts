...
const icons = [
  faFacebookF, faTwitter, faFacebookMessenger, faWhatsapp,
//   faLinkedinIn, faGooglePlusG, faPinterestP, faRedditAlien, faTumblr,
//  , faVk,  faTelegramPlane, faMix, faXing, faCommentAlt,  faLine,
